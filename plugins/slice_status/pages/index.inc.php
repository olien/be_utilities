...
$config_file = $REX['INCLUDE_PATH'] . '/addons/be_utilities/plugins/slice_status/settings.inc.php';
				...
				<div class="rex-form-wrapper">
					...
					<div class="rex-form-row rex-form-element-v1">
						<p class="rex-form-col-a rex-form-read">
							...
							<span class="rex-form-read" id="css_hint"><code>/files/addons/be_utilities/plugins/slice_status/slice_status.css</code></span>
						</p>
					</div>
