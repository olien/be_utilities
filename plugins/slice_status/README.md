Slice Status Plugin (aka Slice On/Off) für REDAXO 4
===================================================

Dieses REDAXO-Plugin fügt einen On/Offline-Schalter für Artikelblöcke (Slices) hinzu. 
...
* Plugin-Ordner lautet: `slice_status`
* AJAX Modus auschaltbar über die config.inc.php
* Farbe/Opacity der Offline-Slices änderbar in `/files/addons/be_extensions/plugins/slice_status/slice_status.css`
