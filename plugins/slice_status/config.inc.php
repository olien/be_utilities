<?php
// includes
require_once($REX['INCLUDE_PATH'] . '/addons/be_utilities/plugins/slice_status/classes/class.rex_slice_status.inc.php');
...
if ($REX['REDAXO']) {
	...
	// register plugin
	rex_plugin_factory::registerPlugin('be_utilities', 'slice_status', 'Slice Status', $I18N->msg('slice_status_description'), '1.2.5', 'WebDevOne', 'forum.redaxo.de', true);

	// includes
	include($REX['INCLUDE_PATH'] . '/addons/be_utilities/plugins/slice_status/settings.inc.php');
