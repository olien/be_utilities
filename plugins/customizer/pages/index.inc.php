...
if ($func == 'update')
{
	...
	$REX['ADDON']['customizer']['colorize_favicon'] = 0;
	
	if(rex_request("colorize_favicon") == 1) {
		$REX['ADDON']['customizer']['colorize_favicon'] = 1;
	}
...
$REX[\'ADDON\'][\'customizer\'][\'colorize_favicon\'] = '.$REX['ADDON']['customizer']['colorize_favicon'].';
...
$REX[\'ADDON\'][\'customizer\'][\'liquid\'] = '.$REX['ADDON']['customizer']['liquid'].';
	...
	if ($REX['ADDON']['customizer']['colorize_favicon'] && $REX['ADDON']['customizer']['labelcolor'] != '') {
		$hexColor = $REX['ADDON']['customizer']['labelcolor'];
		$pluginMediaPath = realpath($REX['HTDOCS_PATH'] . $REX['MEDIA_ADDON_DIR']) . DIRECTORY_SEPARATOR . 'be_utilities/plugins/customizer/';

		// generate favicon
		rex_customizer_utils::makeFavIcon($hexColor, $pluginMediaPath);

		// change color immediately 
		echo '<link rel="shortcut icon" href="../' . $REX['MEDIA_ADDON_DIR'] . '/be_utilities/plugins/customizer/' . rex_customizer_utils::getColorizedFavIconName($hexColor) . '" />' . PHP_EOL;
              ...
              <div class="rex-form-wrapper">
				...
				<div class="rex-form-row">
                  <p class="rex-form-col-a rex-form-checkbox">
                    ...
                    if($REX['ADDON']['customizer']['colorize_favicon']) echo 'checked="checked"';
                    echo ' />
                    <label for="colorize_favicon">'.$I18N->msg("customizer_colorize_favicon").'</label>
                  </p>
                </div>
