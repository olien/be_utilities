...
$themes = array();
foreach (glob($REX["INCLUDE_PATH"]."/addons/be_utilities/plugins/customizer/files/codemirror/theme/*.css") as $filename) {
...
if ($func == 'update')
{
  ...
  $REX['ADDON']['be_utilities']['plugin_customizer']['codemirror_theme'] = htmlspecialchars(substr(rex_request("customizer-codemirror_theme","string"),0,20));

  $REX['ADDON']['be_utilities']['plugin_customizer']['projectname'] = htmlspecialchars(rex_request('customizer-projectname', 'string'));

  $labelcolor = rex_request("customizer-labelcolor","string");
  if ($labelcolor == '') {
    $REX['ADDON']['be_utilities']['plugin_customizer']['labelcolor'] = '';
  }
  elseif (preg_match('/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/', $labelcolor)) {
    $REX['ADDON']['be_utilities']['plugin_customizer']['labelcolor'] = htmlspecialchars($labelcolor);
  }
  else {
    $warning = $I18N->msg('customizer_labelcolor_error');
  }

  $REX['ADDON']['be_utilities']['plugin_customizer']['codemirror'] = 0;
  if(rex_request("customizer-codemirror") == 1) {
    $REX['ADDON']['be_utilities']['plugin_customizer']['codemirror'] = 1;
  }

  $REX['ADDON']['be_utilities']['plugin_customizer']['showlink'] = 0;
  if(rex_request("customizer-showlink") == 1) {
    $REX['ADDON']['be_utilities']['plugin_customizer']['showlink'] = 1;
  }

  $REX['ADDON']['be_utilities']['plugin_customizer']['textarea'] = 0;
  if(rex_request("customizer-textarea") == 1) {
    $REX['ADDON']['be_utilities']['plugin_customizer']['textarea'] = 1;
  }

  $REX['ADDON']['be_utilities']['plugin_customizer']['liquid'] = 0;
  if(rex_request("customizer-liquid") == 1) {
    $REX['ADDON']['be_utilities']['plugin_customizer']['liquid'] = 1;
  }
 
  $content = '
$REX[\'ADDON\'][\'be_utilities\'][\'plugin_customizer\'][\'labelcolor\'] = "'.$REX['ADDON']['be_utilities']['plugin_customizer']['labelcolor'].'";
$REX[\'ADDON\'][\'be_utilities\'][\'plugin_customizer\'][\'codemirror_theme\'] = "'.$REX['ADDON']['be_utilities']['plugin_customizer']['codemirror_theme'].'";
$REX[\'ADDON\'][\'be_utilities\'][\'plugin_customizer\'][\'codemirror\'] = '.$REX['ADDON']['be_utilities']['plugin_customizer']['codemirror'].';
$REX[\'ADDON\'][\'be_utilities\'][\'plugin_customizer\'][\'showlink\'] = '.$REX['ADDON']['be_utilities']['plugin_customizer']['showlink'].';
$REX[\'ADDON\'][\'be_utilities\'][\'plugin_customizer\'][\'textarea\'] = '.$REX['ADDON']['be_utilities']['plugin_customizer']['textarea'].';
$REX[\'ADDON\'][\'be_utilities\'][\'plugin_customizer\'][\'liquid\'] = '.$REX['ADDON']['be_utilities']['plugin_customizer']['liquid'].';
  ';
...
$tselect->setSelected($REX['ADDON']['be_utilities']['plugin_customizer']['codemirror_theme']);
        ...
        <div class="rex-area-col-a">
          ...
          <div class="rex-area-content">
            ...
            <div class="rex-form-row">
              ...
              if($REX['ADDON']['be_utilities']['plugin_customizer']['codemirror']) echo 'checked="checked"';
              echo ' />
              	</p>
            </div>
              ...
              <div class="rex-form-wrapper">
                ...
                <div class="rex-form-row">
                  <p class="rex-form-col-a rex-form-text">
                    ...
                    <input class="rex-form-text" type="text" id="rex-form-agk-labelcolor" name="customizer-labelcolor" value="'. $REX['ADDON']['be_utilities']['plugin_customizer']['labelcolor'].'" />
                  </p>
                </div>
                ...
                <div class="rex-form-row">
                  <p class="rex-form-col-a rex-form-checkbox">
                    ...
                    if($REX['ADDON']['be_utilities']['plugin_customizer']['showlink']) echo 'checked="checked"';
                    echo ' />
                ...
                <div class="rex-form-row">
                  <p class="rex-form-col-a rex-form-checkbox">
                    ...
                    if($REX['ADDON']['be_utilities']['plugin_customizer']['textarea']) echo 'checked="checked"';
                    echo ' />
                ...
                <div class="rex-form-row">
                  <p class="rex-form-col-a rex-form-checkbox">
                    ...
                    if($REX['ADDON']['be_utilities']['plugin_customizer']['liquid']) echo 'checked="checked"';
                    echo ' />
