...
if ($REX['REDAXO']) {
	...
	if (($REX['ADDON']['category_separator']['hide_cat_id'] != '') && (rex_request('page') == 'structure' && rex_request('category_id') == '' || rex_request('category_id') == '0') && rex_request('function') == '') { // only for root cats
