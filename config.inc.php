...
if ($REX['REDAXO']) {
	...
	// includes
	include($REX['INCLUDE_PATH'] . '/addons/be_extensions/classes/class.rex_extension.inc.php');
	include($REX['INCLUDE_PATH'] . '/addons/be_extensions/classes/class.rex_extension_manager.inc.php');

	// sub pages
	$REX['ADDON']['be_extensions']['SUBPAGES'] = array();
	$REX['ADDON']['be_extensions']['SUBPAGES'][] = array('' , $I18N->msg('be_extensions_overview'));

	// create extension manager object used by the plugins/extensions
